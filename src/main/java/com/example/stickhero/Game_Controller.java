...
public class Game_Controller {
    ...
    private Player super_hero;
    private Cherry game_cherry;
    private Stick recent_stick;
    private Platform game_walls;
    private Gamescore individual_score;
    private Rotate rotate;
    ArrayList<Platform> walls = new ArrayList<>();
...
//        System.out.println("hello game");
        super_hero = new Player(hero_img1,0,0);
...
//        game_cherry= Cherry.getInstance(cherry);
        ...
        game_walls = new Platform(wall1,wall2,wall3);
...
//        System.out.println(game_walls.width2);
        ...
        individual_score = Gamescore.newGame();
...
//        hero_move_animation.start();
    ...
    public void showGameOverScene() {
        ...
        Gamescore.highest = Math.max(Gamescore.highest, individual_score.getPoints());
        best_score.setText(valueOf(Gamescore.highest));

...
public class Platform implements Renderable, Collidable, Serializable {
    Rectangle wall1;
    Rectangle wall2;
    Rectangle wall3;
    ...
    public Platform(Rectangle wall1, Rectangle wall2, Rectangle wall3){
        this.wall1 = wall1;
        this.wall2 = wall2;
        this.wall3 = wall3;
...
//    }
    ...
    @Override
    public boolean collided(Player hero) {
        if(hero.is_fliped){
